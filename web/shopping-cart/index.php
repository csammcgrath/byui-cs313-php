                    ...
                    <div class="card mb-4">
                            ...
                            <?php
                                if ($_SESSION["cart"]["harryPotter"]["quantity"] == 1) {
                                    echo "<button type='submit' name='harryPotter' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card-body d-flex flex-column" id="hermioneGranger">
                            ...
                            <?php
                                if ($_SESSION["cart"]["hermioneGranger"]["quantity"] == 1) {
                                    echo "<button type='submit' name='hermioneGranger' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <h5 class="card-title">Viktor Krum's Wand</h5>
                            ...
                            <?php
                                if ($_SESSION["cart"]["viktorKrum"]["quantity"] == 1) {
                                    echo "<button type='submit' name='viktorKrum' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card-body d-flex flex-column" id="dracoMalfoy">
                            ...
                            <?php
                                if ($_SESSION["cart"]["dracoMalfoy"]["quantity"] == 1) {
                                    echo "<button type='submit' name='dracoMalfoy' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card mb-4">
                            ...
                            <?php
                                if ($_SESSION["cart"]["ronWeasley1"]["quantity"] == 1) {
                                    echo "<button type='submit' name='ronWeasley1' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card-body d-flex flex-column" id="ronWeasley2">
                            ...
                            <?php
                                if ($_SESSION["cart"]["ronWeasley2"]["quantity"] == 1) {
                                    echo "<button type='submit' name='ronWeasley2' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <h5 class="card-title">Horace Slughorn's Wand</h5>
                            ...
                            <?php
                                if ($_SESSION["cart"]["horaceSlughorn"]["quantity"] == 1) {
                                    echo "<button type='submit' name='horaceSlughorn' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card-body d-flex flex-column" id="elderWand">
                            ...
                            <?php
                                if ($_SESSION["cart"]["elderWand"]["quantity"] == 1) {
                                    echo "<button type='submit' name='elderWand' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card mb-4">
                            ...
                            <?php
                                if ($_SESSION["cart"]["nevilleLongbottom"]["quantity"] == 1) {
                                    echo "<button type='submit' name='nevilleLongbottom' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card-body d-flex flex-column" id="remusLupin">
                            ...
                            <?php
                                if ($_SESSION["cart"]["remusLupin"]["quantity"] == 1) {
                                    echo "<button type='submit' name='remusLupin' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <h5 class="card-title">Fleur Delacour's Wand</h5>
                            ...
                            <?php
                                if ($_SESSION["cart"]["fleurDelacour"]["quantity"] == 1) {
                                    echo "<button type='submit' name='fleurDelacour' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card-body d-flex flex-column" id="cedricDiggory">
                            ...
                            <?php
                                if ($_SESSION["cart"]["cedricDiggory"]["quantity"] == 1) {
                                    echo "<button type='submit' name='cedricDiggory' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card mb-4">
                            ...
                            <?php
                                if ($_SESSION["cart"]["voldemort"]["quantity"] == 1) {
                                    echo "<button type='submit' name='voldemort' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card-body d-flex flex-column" id="bellatrixLestrange">
                            ...
                            <?php
                                if ($_SESSION["cart"]["bellatrixLestrange"]["quantity"] == 1) {
                                    echo "<button type='submit' name='bellatrixLestrange' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <h5 class="card-title">James Potter's Wand</h5>
                            ...
                            <?php
                                if ($_SESSION["cart"]["jamesPotter"]["quantity"] == 1) {
                                    echo "<button type='submit' name='jamesPotter' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
                        ...
                        <div class="card-body d-flex flex-column" id="ginnyWeasley">
                            ...
                            <?php
                                if ($_SESSION["cart"]["ginnyWeasley"]["quantity"] == 1) {
                                    echo "<button type='submit' name='ginnyWeasley' class='btn btn-danger mt-auto'>Remove from cart</button>";
                                } else {
